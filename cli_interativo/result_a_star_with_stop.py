...
class Result_A_Star_With_Stop:
    ...
    def __init__(self, initial_state, search_objective, path, cost, gen_nodes, 
        ...
        self.cost_function = Node_A_Star.cost_function  # Função de custo utilizada
        self.heuristic = Node_A_Star.heuristic_function  # Função heurística utilizada
        self.pharmacy_positions = Node_A_Star.pharmacy_positions.copy()  # Cópia das posições das farmácias
