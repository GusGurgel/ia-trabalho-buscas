...
def DFS(inital_pos, objective_pos, verbose=False) -> Result:
    ...
    while len(stack) > 0:
        ...
        # A função shuffle vai randomizar a ordem que os vizinhos são colocados
        # na pilha de exploração
    ...
    # O resultado da busca é retornado junto com o nó resultante
    return (Result(
        inital_pos,
        objective_pos,
